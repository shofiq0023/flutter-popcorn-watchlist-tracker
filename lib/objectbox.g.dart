...
final _entities = <obx_int.ModelEntity>[
  ...
  obx_int.ModelEntity(
      ...
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 3287475705244907754),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 1801984459014236342),
            name: 'createdAt',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
...
obx_int.ModelDefinition getObjectBoxModel() {
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    ImportExportEntity: obx_int.EntityDefinition<ImportExportEntity>(
        model: _entities[2],
        toOneRelations: (ImportExportEntity object) => [],
        toManyRelations: (ImportExportEntity object) => {},
        getId: (ImportExportEntity object) => object.id,
        setId: (ImportExportEntity object, int id) {
          object.id = id;
        },
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object = ImportExportEntity()
            ..id = const fb.Int64Reader().vTableGet(buffer, rootOffset, 4, 0)
            ..createdAt = DateTime.fromMillisecondsSinceEpoch(
                const fb.Int64Reader().vTableGet(buffer, rootOffset, 8, 0))
            ..title = const fb.StringReader(asciiOptimization: true)
...
/// [ImportExportEntity] entity fields to define ObjectBox queries.
class ImportExportEntity_ {
  /// See [ImportExportEntity.id].
  static final id =
      obx.QueryIntegerProperty<ImportExportEntity>(_entities[2].properties[0]);

  /// See [ImportExportEntity.createdAt].
  static final createdAt =
      obx.QueryDateProperty<ImportExportEntity>(_entities[2].properties[1]);
